<?php if(!class_exists('Rain\Tpl')){exit;}?>        <header class="header">
        ...
        <div class="container">
          <section class="people-cards">
            <article class="people-cards__card">
              <img src="res/img/c01.jpg" alt="Carousel Img" class="people-cards__image">

              <div class="people-cards__avatar">
                <img src="res/img/teamsprite_01.png" alt="Carousel Img">
              </div>
            ...
            <article class="people-cards__card">
              <img src="res/img/c02.jpg" alt="Carousel Img" class="people-cards__image">

              <div class="people-cards__avatar">
                <img src="res/img/teamsprite_02.png" alt="Carousel Img">
              </div>
              <div class="people-cards__content">
                <h2 class="people-cards__title">Lorem ipsum dolor sit amet consectetur</h2>
                <p class="people-cards__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris mattis suscipit est, ut imperdiet tortor. Proin sed molestie massa.</p>
            ...
            <article class="people-cards__card">
              <img src="res/img/c03.jpg" alt="Carousel Img" class="people-cards__image">

              <div class="people-cards__avatar">
                <img src="res/img/teamsprite_03.png" alt="Carousel Img">
              </div>
              <div class="people-cards__content">
                <h2 class="people-cards__title">Lorem ipsum dolor sit amet consectetur</h2>
                <p class="people-cards__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris mattis suscipit est, ut imperdiet tortor. Proin sed molestie massa.</p>
            ...
            <article class="people-cards__card">
              <img src="res/img/c04.jpg" alt="Carousel Img" class="people-cards__image">

              <div class="people-cards__avatar">
                <img src="res/img/teamsprite_04.png" alt="Carousel Img">
              </div>
              <div class="people-cards__content">
                <h2 class="people-cards__title">Lorem ipsum dolor sit amet consectetur</h2>
                <p class="people-cards__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris mattis suscipit est, ut imperdiet tortor. Proin sed molestie massa.</p>
        ...
        <section class="last-articles">
          ...
          <div class=" last-articles_thumbs">
              <a href="#"><img src="res/img/articles/01.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/02.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/03.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/04.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/05.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/06.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/07.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/08.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/09.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/10.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/11.jpg" alt=""></a>
              <a href="#"><img src="res/img/articles/12.jpg" alt=""></a>
          </div>
        </section>

        <div class="laptop-slider">
          <div class="slideshow">
            <figure><img alt="" src="res/img/slider/slide-01.png" /></figure>
            <figure><img alt="" src="res/img/slider/slide-02.png" /></figure>
            <figure><img alt="" src="res/img/slider/slide-01.png" /></figure>
            <figure><img alt="" src="res/img/slider/slide-02.png" /></figure>
