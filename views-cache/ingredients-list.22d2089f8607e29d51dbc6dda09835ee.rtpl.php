    	...
    	<?php $counter1=-1;  if( isset($ingredients) && ( is_array($ingredients) || $ingredients instanceof Traversable ) && sizeof($ingredients) ) foreach( $ingredients as $key1 => $value1 ){ $counter1++; ?>
        	<article class="ingredient-cards__card">
              <div class="ingredientImage">
                <img <?php if( $value1["pictureId"] != '' ){ ?> src="/res/site/img/igrendients_pictures/<?php echo htmlspecialchars( $value1["pictureId"], ENT_COMPAT, 'UTF-8', FALSE ); ?>.jpg" <?php }else{ ?> src="/res/site/img/defaults/no-ingredient.jpg" <?php } ?> alt="Foto de ingrediente" class="ingredient-cards__image ingredient-box">              
              </div>
